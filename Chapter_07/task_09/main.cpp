 ...
 * Описание задачи:
 * ================
 * Предложите три усовершенствования калькулятора (не упомянутых в главе).
 * Реализуйте одно из них
 *
 * Идея реализации:
 * ================
 * В качестве таких усовершенствований можно реализовать:
 * 1. Возведение в степень
 * 2. Тригонометрические функции: sin(x), cos(x), tg(x), ctg(x)
 * 3. Логарифм, экспонента и т.д.
 *
 * В данной программе реализован певый пукнкт - возведение в степень. Для этого
 * необходимо в функцию primary() добавить ещё одну проверку. Функция возведения в
 * степень называется pow, которая вызывается с двумя параметрами: число и степень.
 * */
