 ...
 * Описание задачи:
 * ================
 * Каждая программа должна содержать подсказки для пользователя. Пусть при вводе
 * буквы H (в любом регистре) калькулятор выводит на экран инструкцию по
 * эксплуатации.
 *
 * Идея реализации:
 * ================
 * В данной реализации в функцию calculate() добавлена проверка на вызов справки и
 * реализована функция write_help, которая, собственно, и выводит справку.
 * В get() добавлена проверка на ввод символов для получения справки.
 * */
